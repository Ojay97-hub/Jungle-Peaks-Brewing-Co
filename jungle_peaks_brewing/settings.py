...
if os.getenv('DEVELOPMENT'):
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'  # Debug Mode (prints to console)
    DEFAULT_FROM_EMAIL = 'junglepeaksbrewing@example.com'
else:
    ...
    DEFAULT_FROM_EMAIL = EMAIL_HOST_USER  # Uses your email address as sender