...
class Order(models.Model):
    ...
    def update_total(self):
        ...
        self.order_total = self.lineitems.filter(product__isnull=False).aggregate(
            Sum('lineitem_total')
        )['lineitem_total__sum'] or 0  # Default to 0 if None
...
class OrderLineItem(models.Model):
    ...
    def __str__(self):
        return f'SKU {self.product.sku if self.product else "Unknown"} on order {self.order.order_number}'
